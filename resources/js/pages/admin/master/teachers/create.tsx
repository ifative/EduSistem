...
export default function TeachersCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        nip: '', nuptk: '', name: '', gender: '', email: '', phone: '', address: '', position: '', status: 'active',
    });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                <h1 className="text-2xl font-bold">{t('teachers.create')}</h1>
                <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.gender} onValueChange={(v) => setData('gender', v)}>
                                        <SelectTrigger><SelectValue placeholder={t('teachers.select_gender')} /></SelectTrigger>
                                        <SelectContent>
                    ...
                    <div className="flex gap-4">
                        <Button type="submit" disabled={processing}>{processing ? t('teachers.creating') : t('teachers.create')}</Button>
