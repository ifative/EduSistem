...
export default function PeriodsCreate({ academicYears }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={t('admin:ppdb.periods.create')} />

            <div className="flex flex-col gap-4 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">{t('admin:ppdb.periods.create')}</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex gap-4">
                        <Button type="submit" disabled={processing}>
                            {processing ? t('admin:ppdb.periods.creating') : t('admin:ppdb.periods.create')}
                        </Button>
